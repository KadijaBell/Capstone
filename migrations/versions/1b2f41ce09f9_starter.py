...
Revision ID: 1b2f41ce09f9
Revises: 
Create Date: 2025-01-31 20:12:16.341490
...
def upgrade():
    ...
    sa.Column('description', sa.Text(), nullable=False),
    sa.Column('type', sa.Enum('event', 'portfolio', 'community', 'data', 'influencer', 'celebrity', name='event_type'), nullable=False),
